...
- **Recents** are implicit: a destination is recorded only when it enters the Plan wizard's Basics step (`MAX_RECENTS=24`), stored in the existing `tp_my_list` key in MRU order
