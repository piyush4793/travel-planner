...
import SettingsModal from "@/components/ai/SettingsModal.tsx";
import { getActiveProvider, getLLMKeys, saveLLMKeys } from "@/core/utils/ai/llmSettings.ts";
import { LS_KEYS } from "@/core/lsKeys.ts";
import type { BudgetBasis } from "@/core/utils/budget.ts";
...
vi.mock("@/utils/ai/llmProvider.ts", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/utils/ai/llmProvider.ts")>();
  return {
    ...actual,
...
vi.mock("@/utils/backup.ts", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/utils/backup.ts")>();
  return {
    ...actual,
