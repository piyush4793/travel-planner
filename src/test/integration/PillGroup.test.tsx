...
describe("PillGroup", () => {
  ...
  it("applies active styling to the selected pill", () => {
    ...
    expect(screen.getByRole("button", { name: "Asia" })).toHaveClass("bg-white", "text-blue-700");
    expect(screen.getByRole("button", { name: "All" })).not.toHaveClass("bg-white", "text-blue-700");
  });
