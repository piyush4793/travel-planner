...
export default function ShareButton({ country, homeCountry, plan }: Props) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-[11px] font-semibold transition-colors focus-ring ring-1 bg-white text-gray-500 ring-gray-200 hover:bg-gray-50 hover:text-gray-700 disabled:opacity-60 disabled:cursor-wait"
