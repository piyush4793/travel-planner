...
function PlanProgressSummaryInner({ plan }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-[#e4dece] bg-white/70 p-4 shadow-[0_1px_3px_rgba(20,40,30,0.05)]">
      <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#6f6a5d]">Your trip so far</p>
      <div className="mt-1.5 flex items-baseline gap-2">
        <span className="font-display text-lg font-semibold text-[#16241d]">{plan.days.length} days</span>
        <span aria-hidden="true" className="text-[#cfc9b8]">·</span>
        <span className="text-sm font-medium text-[#1e2a25]">
