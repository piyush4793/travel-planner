          ...
          <button
            ...
            className={
              ...
              (selected
                ...
                : "bg-white ring-[#e0dac9] hover:bg-[#f7f4ec] hover:ring-[#d8d2c2] hover:-translate-y-0.5")
            }
          >
            {hasKey && (
              <span
            ...
            <span className={"inline-flex items-center gap-1 text-[9px] font-semibold " + (hasKey ? "text-emerald-600" : "text-[#a8a293]")}>
