...
- **Multi-unit trip funnel** (Places today; Review is the next phase). The primary stop stays on `usePlanBuilder`; every *additional* stop is loaded and curated together, then all stops are composed into one plan:
